...
public class Constants {
    ...
    //Topics
    public static final String PUBLISH_TOPIC_LEFT_FAN = "SmartGarden/Actuators/LeftFan";
    public static final String PUBLISH_TOPIC_RIGHT_FAN = "SmartGarden/Actuators/RightFan";
